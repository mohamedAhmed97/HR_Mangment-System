"""
Django settings for mashreq_HRMS project.
...
SECRET_KEY = '34*n!j7kg*rq9!9d53k98lfx3*ae2k=ku-(_2ul9s(vb-gn$65'
...
ROOT_URLCONF = 'mashreq_HRMS.urls'
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, 'mashreq_HRMS/templates/'),
