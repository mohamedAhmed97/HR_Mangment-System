    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_birth', models.DateField(default=None, null=True, verbose_name='date_of_birth')),
                ...
                ('role', models.CharField(choices=[('Manger', 'Manger'), ('HR', 'HR'), ('Employee', 'Employee')], max_length=12)),
